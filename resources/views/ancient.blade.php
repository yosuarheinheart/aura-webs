            ...
            <ul>
                <li style="--accent-color:#D3634A">
                    ...
                    <div class="content-box2">
                        <div class="title-in text-center">Artopia Registration</div>
                    </div>
                </li>
                ...
                <li style="--accent-color:#872009">
                    ...
                    <div class="content-box2">
                        <div class="title-in text-center">Artopia Briefing</div>
                    </div>
                </li>
                <li style="--accent-color:#872009">
                    <div class="date">29 September 2025</div>
                    <div class="content-box2">
                        <div class="title-in text-center">Artopia Opening</div>
                    </div>
                </li>
                <li style="--accent-color:#45150A">
                    <div class="date">29 September - 02 October 2025</div>
                    <div class="content-box2">
                        <div class="title-in text-center">Artopia Event</div>
                    </div>
                </li>
                <li style="--accent-color:#2D0B03">
                    <div class="date">02 October 2025</div>
                    <div class="content-box2">
                        <div class="title-in text-center">Artopia Closing</div>
                    </div>
                </li>
            </ul>
        </div>
